...
GitHub Discussions provides a place for conversations that are not necessarily actionable tasks.
...
```text
What authentication method should this project use?
```
...
Suppose you are building a project.
...
If Discussions are enabled for a repository, you can access them from the repository navigation.
...
Discussions can be organized into categories.
...
The available categories depend on the repository configuration.

---

# Q&A Discussions

Q&A is useful when someone has a question.
