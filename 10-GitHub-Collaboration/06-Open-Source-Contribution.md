...
These files can contain important project rules.
...
Always follow the repository's contribution instructions.

---

# CODE_OF_CONDUCT.md

This describes expected behavior for contributors and community members.

Follow it when communicating with maintainers and other contributors.

---

# LICENSE

The license defines how the project's code can be used, modified, and distributed.

Do not assume that all GitHub code can be used without restrictions.

---

# Finding a Project

Look for repositories that match your interests and current skills.
...
Start with projects that are understandable at your current level.

---

# Finding Good First Issues

Many projects use labels such as:
...
However, always read the issue and contribution instructions first.
